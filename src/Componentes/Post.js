...
export default function Post ({poste}){
  ...
  const hearts = [<ion-icon data-test="like-post" onClick={like} name="heart-outline"></ion-icon>, <ion-icon data-test="like-post" class="heart-red" onClick={dislike} name="heart"></ion-icon>]
